 ...
 */
package com.doctorkeeper.dslrkeeper3.view.liveView;
...
import com.doctorkeeper.dslrkeeper3.PictureView;
...
import com.doctorkeeper.dslrkeeper3.view.dslr.DSLRPhotoAdapter;
import com.doctorkeeper.dslrkeeper3.view.phone_camera.PhoneCameraFragment;
        ...
        (getActivity()).runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (enabled) {
                    ...
                    dslrTextView.setText("카메라를 연결해 주세요3");
...
//                    camera_ready_Notice.setVisibility(View.VISIBLE);
                    ...
                    dslrTextView.setText("촬영 가능 합니다3");
