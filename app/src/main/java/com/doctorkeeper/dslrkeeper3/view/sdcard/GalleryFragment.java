 ...
 */
package com.doctorkeeper.dslrkeeper3.view.sdcard;
...
import com.doctorkeeper.dslrkeeper3.view.dslr.DSLRFragment;
import com.doctorkeeper.dslrkeeper3.view.sdcard.GalleryAdapter.ViewHolder;
...
// DeviceDefault_Light_Dialog
        ...
        builder.setTitle(selectedImageNumber+"개 이미지 선택");
        builder.setMessage("");
        ...
        builder.setNeutralButton("계속 선택", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                // User cancelled the dialog
                Log.w(TAG,"계속선택 클릭");
                dialog.cancel();
