 ...
 */
package com.doctorkeeper.dslrkeeper3.ptp.commands.nikon;

import com.doctorkeeper.dslrkeeper3.ptp.NikonCamera;
import com.doctorkeeper.dslrkeeper3.ptp.PtpAction;
import com.doctorkeeper.dslrkeeper3.ptp.PtpCamera.IO;
import com.doctorkeeper.dslrkeeper3.ptp.PtpConstants;
import com.doctorkeeper.dslrkeeper3.ptp.PtpConstants.Datatype;
import com.doctorkeeper.dslrkeeper3.ptp.PtpConstants.Operation;
import com.doctorkeeper.dslrkeeper3.ptp.PtpConstants.Property;
    ...
    public void exec(IO io) {
        ...
        if (openSession.getResponseCode() == PtpConstants.Response.Ok) {
            if (camera.hasSupportForOperation(Operation.NikonGetVendorPropCodes)) {
                ...
                if(deviceInfo.contains("Nikon")&&(deviceInfo.contains("D5300")||deviceInfo.contains("D5500")||deviceInfo.contains("D5600")
                        ||deviceInfo.contains("D5100")||deviceInfo.contains("D5200")||deviceInfo.contains("D610")||deviceInfo.contains("D810")
                        ||deviceInfo.contains("D800")||deviceInfo.contains("D700")||deviceInfo.contains("D7200")
                        ||deviceInfo.contains("D3400")||deviceInfo.contains("D3500")||deviceInfo.contains("D7100")
                )) {
